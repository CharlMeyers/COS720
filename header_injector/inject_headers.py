...
for i, emailMap in enumerate(filesToProcess):
	...
	fabricatedEmailPath = "../../fabricated_emails/" + emailPath[13:];
	...
	if i % 1000 == 0:
		print("\rFabricating emails progress: " + str(round(i / len(filesToProcess) * 100, 2)) + "%", end='', flush=True);
...
print("\rFabricating emails progress: " + str(round(i / len(filesToProcess) * 100, 2)) + "%");
